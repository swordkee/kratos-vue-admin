...
func (c *sysPostClient) ListPost(ctx context.Context, in *ListPostRequest, opts ...grpc.CallOption) (*ListPostReply, error) {
	...
	err := c.cc.Invoke(ctx, SysPost_ListPost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sysPostClient) CreatePost(ctx context.Context, in *CreatePostRequest, opts ...grpc.CallOption) (*CreatePostReply, error) {
	...
	err := c.cc.Invoke(ctx, SysPost_CreatePost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sysPostClient) UpdatePost(ctx context.Context, in *UpdatePostRequest, opts ...grpc.CallOption) (*UpdatePostReply, error) {
	...
	err := c.cc.Invoke(ctx, SysPost_UpdatePost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sysPostClient) DeletePost(ctx context.Context, in *DeletePostRequest, opts ...grpc.CallOption) (*DeletePostReply, error) {
	...
	err := c.cc.Invoke(ctx, SysPost_DeletePost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSysPostServer must be embedded to have
...
func (UnimplementedSysPostServer) testEmbeddedByValue()                 {}
...
func RegisterSysPostServer(s grpc.ServiceRegistrar, srv SysPostServer) {
	// If the following call panics, it indicates UnimplementedSysPostServer was
