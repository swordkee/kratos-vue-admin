...
func RegisterDictDataHTTPServer(s *http.Server, srv DictDataHTTPServer) {
	r := s.Route("/")
	r.Handle("GET", "/system/dict/data/type", _DictData_ListDictData0_HTTP_Handler(srv))
	r.Handle("POST", "/system/dict/data", _DictData_CreateDictData0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/dict/data", _DictData_UpdateDictData0_HTTP_Handler(srv))
	r.Handle("DELETE", "/system/dict/data/{dictCode}", _DictData_DeleteDictData0_HTTP_Handler(srv))
	r.Handle("GET", "/system/dict/data/info/{dictCode}", _DictData_FindDictData0_HTTP_Handler(srv))
}
...
func (c *DictDataHTTPClientImpl) CreateDictData(ctx context.Context, in *CreateDictDataRequest, opts ...http.CallOption) (*CreateDictDataReply, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationDictDataCreateDictData),
...
func (c *DictDataHTTPClientImpl) DeleteDictData(ctx context.Context, in *DeleteDictDataRequest, opts ...http.CallOption) (*DeleteDictDataReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDictDataDeleteDictData),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *DictDataHTTPClientImpl) FindDictData(ctx context.Context, in *FindDictDataRequest, opts ...http.CallOption) (*FindDictDataReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDictDataFindDictData),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *DictDataHTTPClientImpl) ListDictData(ctx context.Context, in *ListDictDataRequest, opts ...http.CallOption) (*ListDictDataReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDictDataListDictData),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *DictDataHTTPClientImpl) UpdateDictData(ctx context.Context, in *UpdateDictDataRequest, opts ...http.CallOption) (*UpdateDictDataReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationDictDataUpdateDictData),
		http.PathTemplate(pattern),
	}, opts...)
