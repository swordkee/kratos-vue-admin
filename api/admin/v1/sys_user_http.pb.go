...
const OperationSysUserGetLoginConfig = "/api.admin.v1.SysUser/GetLoginConfig"
...
type SysUserHTTPServer interface {
	...
	// GetLoginConfig 登录页开关（公开；前端按此决定是否展示图形验证码/手机验证码登录）
	GetLoginConfig(context.Context, *GetLoginConfigRequest) (*GetLoginConfigReply, error)
	// ListSysUser 用户列表
...
func RegisterSysUserHTTPServer(s *http.Server, srv SysUserHTTPServer) {
	r := s.Route("/")
	r.Handle("POST", "/system/user", _SysUser_CreateSysUser0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/user", _SysUser_UpdateSysUser0_HTTP_Handler(srv))
	r.Handle("DELETE", "/system/user/{id}", _SysUser_DeleteSysUser0_HTTP_Handler(srv))
	r.Handle("GET", "/system/user/getById/{id}", _SysUser_FindSysUser0_HTTP_Handler(srv))
	r.Handle("GET", "/system/user/list", _SysUser_ListSysUser0_HTTP_Handler(srv))
	r.Handle("GET", "/system/user/getCaptcha", _SysUser_FindCaptcha0_HTTP_Handler(srv))
	r.Handle("POST", "/system/user/login", _SysUser_Login0_HTTP_Handler(srv))
	r.Handle("GET", "/system/user/loginConfig", _SysUser_GetLoginConfig0_HTTP_Handler(srv))
	...
	r.Handle("GET", "/system/user/getRoPo", _SysUser_FindUserRolePost0_HTTP_Handler(srv))
	r.Handle("GET", "/system/user/secret", _SysUser_FindUserGoogleSecret0_HTTP_Handler(srv))
}
...
func _SysUser_GetLoginConfig0_HTTP_Handler(srv SysUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetLoginConfigRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationSysUserGetLoginConfig)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetLoginConfig(ctx, req.(*GetLoginConfigRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetLoginConfigReply)
		return ctx.Result(200, reply)
	}
}
...
type SysUserHTTPClient interface {
	...
	// GetLoginConfig 登录页开关（公开；前端按此决定是否展示图形验证码/手机验证码登录）
	GetLoginConfig(ctx context.Context, req *GetLoginConfigRequest, opts ...http.CallOption) (rsp *GetLoginConfigReply, err error)
	// ListSysUser 用户列表
...
func (c *SysUserHTTPClientImpl) Auth(ctx context.Context, in *AuthRequest, opts ...http.CallOption) (*AuthReply, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationSysUserAuth),
...
func (c *SysUserHTTPClientImpl) ChangeStatus(ctx context.Context, in *ChangeStatusRequest, opts ...http.CallOption) (*ChangeStatusReply, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationSysUserChangeStatus),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *SysUserHTTPClientImpl) CreateSysUser(ctx context.Context, in *CreateSysUserRequest, opts ...http.CallOption) (*CreateSysUserReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationSysUserCreateSysUser),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *SysUserHTTPClientImpl) DeleteSysUser(ctx context.Context, in *DeleteSysUserRequest, opts ...http.CallOption) (*DeleteSysUserReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserDeleteSysUser),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *SysUserHTTPClientImpl) FindCaptcha(ctx context.Context, in *FindCaptchaRequest, opts ...http.CallOption) (*FindCaptchaReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserFindCaptcha),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) FindPostInit(ctx context.Context, in *FindPostInitRequest, opts ...http.CallOption) (*FindPostInitReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserFindPostInit),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) FindSysUser(ctx context.Context, in *FindSysUserRequest, opts ...http.CallOption) (*FindSysUserReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserFindSysUser),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) FindUserGoogleSecret(ctx context.Context, in *FindUserGoogleSecretRequest, opts ...http.CallOption) (*FindUserGoogleSecretReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserFindUserGoogleSecret),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) FindUserRolePost(ctx context.Context, in *FindUserRolePostRequest, opts ...http.CallOption) (*FindUserRolePostReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserFindUserRolePost),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
// GetLoginConfig 登录页开关（公开；前端按此决定是否展示图形验证码/手机验证码登录）
func (c *SysUserHTTPClientImpl) GetLoginConfig(ctx context.Context, in *GetLoginConfigRequest, opts ...http.CallOption) (*GetLoginConfigReply, error) {
	var out GetLoginConfigReply
	pattern := "/system/user/loginConfig"
	path := http.BuildPath(pattern, in, http.WithQueryParams())
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserGetLoginConfig),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) ListSysUser(ctx context.Context, in *ListSysUserRequest, opts ...http.CallOption) (*ListSysUserReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationSysUserListSysUser),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) Login(ctx context.Context, in *LoginRequest, opts ...http.CallOption) (*LoginReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationSysUserLogin),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) UpdatePassword(ctx context.Context, in *UpdatePasswordRequest, opts ...http.CallOption) (*UpdatePasswordReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationSysUserUpdatePassword),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
...
func (c *SysUserHTTPClientImpl) UpdateSysUser(ctx context.Context, in *UpdateSysUserRequest, opts ...http.CallOption) (*UpdateSysUserReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationSysUserUpdateSysUser),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
