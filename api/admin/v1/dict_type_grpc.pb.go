...
func (c *dictTypeClient) ListDictType(ctx context.Context, in *ListDictTypeRequest, opts ...grpc.CallOption) (*ListDictTypeReply, error) {
	...
	err := c.cc.Invoke(ctx, DictType_ListDictType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictTypeClient) CreateDictType(ctx context.Context, in *CreateDictTypeRequest, opts ...grpc.CallOption) (*CreateDictTypeReply, error) {
	...
	err := c.cc.Invoke(ctx, DictType_CreateDictType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictTypeClient) UpdateDictType(ctx context.Context, in *UpdateDictTypeRequest, opts ...grpc.CallOption) (*UpdateDictTypeReply, error) {
	...
	err := c.cc.Invoke(ctx, DictType_UpdateDictType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictTypeClient) DeleteDictType(ctx context.Context, in *DeleteDictTypeRequest, opts ...grpc.CallOption) (*DeleteDictTypeReply, error) {
	...
	err := c.cc.Invoke(ctx, DictType_DeleteDictType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDictTypeServer must be embedded to have
...
func (UnimplementedDictTypeServer) FindDictType(context.Context, *FindDictTypeRequest) (*FindDictTypeReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDictType not implemented")
}
func (UnimplementedDictTypeServer) mustEmbedUnimplementedDictTypeServer() {}
func (UnimplementedDictTypeServer) testEmbeddedByValue()                  {}
...
func RegisterDictTypeServer(s grpc.ServiceRegistrar, srv DictTypeServer) {
	// If the following call panics, it indicates UnimplementedDictTypeServer was
