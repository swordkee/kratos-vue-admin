...
const (
	...
	SysUser_GetLoginConfig_FullMethodName       = "/api.admin.v1.SysUser/GetLoginConfig"
...
type SysUserClient interface {
	...
	GetLoginConfig(ctx context.Context, in *GetLoginConfigRequest, opts ...grpc.CallOption) (*GetLoginConfigReply, error)
	// 登出
...
func (c *sysUserClient) GetLoginConfig(ctx context.Context, in *GetLoginConfigRequest, opts ...grpc.CallOption) (*GetLoginConfigReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLoginConfigReply)
	err := c.cc.Invoke(ctx, SysUser_GetLoginConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSysUserServer) FindSysUser(context.Context, *FindSysUserRequest) (*FindSysUserReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindSysUser not implemented")
}
func (UnimplementedSysUserServer) ListSysUser(context.Context, *ListSysUserRequest) (*ListSysUserReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSysUser not implemented")
}
func (UnimplementedSysUserServer) FindCaptcha(context.Context, *FindCaptchaRequest) (*FindCaptchaReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindCaptcha not implemented")
}
func (UnimplementedSysUserServer) Login(context.Context, *LoginRequest) (*LoginReply, error) {
	return nil, status.Error(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedSysUserServer) GetLoginConfig(context.Context, *GetLoginConfigRequest) (*GetLoginConfigReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLoginConfig not implemented")
}
...
func (UnimplementedSysUserServer) FindPostInit(context.Context, *FindPostInitRequest) (*FindPostInitReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindPostInit not implemented")
}
func (UnimplementedSysUserServer) FindUserRolePost(context.Context, *FindUserRolePostRequest) (*FindUserRolePostReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindUserRolePost not implemented")
}
func (UnimplementedSysUserServer) FindUserGoogleSecret(context.Context, *FindUserGoogleSecretRequest) (*FindUserGoogleSecretReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindUserGoogleSecret not implemented")
}
...
func RegisterSysUserServer(s grpc.ServiceRegistrar, srv SysUserServer) {
	// If the following call panics, it indicates UnimplementedSysUserServer was
...
func _SysUser_GetLoginConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLoginConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SysUserServer).GetLoginConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SysUser_GetLoginConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SysUserServer).GetLoginConfig(ctx, req.(*GetLoginConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SysUser_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLoginConfig",
			Handler:    _SysUser_GetLoginConfig_Handler,
		},
		{
			MethodName: "Logout",
