...
func RegisterMenusHTTPServer(s *http.Server, srv MenusHTTPServer) {
	r := s.Route("/")
	r.Handle("POST", "/system/menu", _Menus_CreateMenus0_HTTP_Handler(srv))
	r.Handle("GET", "/system/menu/list", _Menus_ListMenus0_HTTP_Handler(srv))
	r.Handle("GET", "/system/menu/menuTreeSelect", _Menus_QueryMenusTree0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/menu", _Menus_UpdateMenus0_HTTP_Handler(srv))
	r.Handle("DELETE", "/system/menu/{id}", _Menus_DeleteMenus0_HTTP_Handler(srv))
	r.Handle("GET", "/system/menu/{id}", _Menus_FindMenus0_HTTP_Handler(srv))
	r.Handle("GET", "/system/menu/roleMenuTreeSelect/{roleId}", _Menus_RoleMenuTreeSelect0_HTTP_Handler(srv))
}
...
func (c *MenusHTTPClientImpl) CreateMenus(ctx context.Context, in *CreateMenusRequest, opts ...http.CallOption) (*CreateMenusReply, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationMenusCreateMenus),
...
func (c *MenusHTTPClientImpl) DeleteMenus(ctx context.Context, in *DeleteMenusRequest, opts ...http.CallOption) (*DeleteMenusReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationMenusDeleteMenus),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *MenusHTTPClientImpl) FindMenus(ctx context.Context, in *FindMenusRequest, opts ...http.CallOption) (*FindMenusReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationMenusFindMenus),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *MenusHTTPClientImpl) ListMenus(ctx context.Context, in *ListMenusRequest, opts ...http.CallOption) (*ListMenusReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationMenusListMenus),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *MenusHTTPClientImpl) QueryMenusTree(ctx context.Context, in *QueryMenusTreeRequest, opts ...http.CallOption) (*QueryMenusTreeReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationMenusQueryMenusTree),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *MenusHTTPClientImpl) RoleMenuTreeSelect(ctx context.Context, in *RoleMenuTreeSelectRequest, opts ...http.CallOption) (*RoleMenuTreeSelectReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationMenusRoleMenuTreeSelect),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *MenusHTTPClientImpl) UpdateMenus(ctx context.Context, in *UpdateMenusRequest, opts ...http.CallOption) (*UpdateMenusReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationMenusUpdateMenus),
		http.PathTemplate(pattern),
	}, opts...)
