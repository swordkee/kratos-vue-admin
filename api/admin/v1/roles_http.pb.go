...
func RegisterRolesHTTPServer(s *http.Server, srv RolesHTTPServer) {
	r := s.Route("/")
	r.Handle("POST", "/system/role", _Roles_CreateRoles0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/role", _Roles_UpdateRoles0_HTTP_Handler(srv))
	r.Handle("GET", "/system/role/list", _Roles_ListRoles0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/role/changeStatus", _Roles_ChangeRoleStatus0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/role/dataScope", _Roles_DataScope0_HTTP_Handler(srv))
	r.Handle("DELETE", "/system/role/{id}", _Roles_DeleteRoles0_HTTP_Handler(srv))
	r.Handle("GET", "/system/role/{id}", _Roles_FindRoles0_HTTP_Handler(srv))
}
...
func (c *RolesHTTPClientImpl) ChangeRoleStatus(ctx context.Context, in *ChangeRoleStatusRequest, opts ...http.CallOption) (*ChangeRoleStatusReply, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationRolesChangeRoleStatus),
...
func (c *RolesHTTPClientImpl) CreateRoles(ctx context.Context, in *CreateRolesRequest, opts ...http.CallOption) (*CreateRolesReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationRolesCreateRoles),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *RolesHTTPClientImpl) DataScope(ctx context.Context, in *DataScopeRequest, opts ...http.CallOption) (*DataScopeReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationRolesDataScope),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
...
func (c *RolesHTTPClientImpl) DeleteRoles(ctx context.Context, in *DeleteRolesRequest, opts ...http.CallOption) (*DeleteRolesReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationRolesDeleteRoles),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *RolesHTTPClientImpl) FindRoles(ctx context.Context, in *FindRolesRequest, opts ...http.CallOption) (*FindRolesReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationRolesFindRoles),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *RolesHTTPClientImpl) ListRoles(ctx context.Context, in *ListRolesRequest, opts ...http.CallOption) (*ListRolesReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationRolesListRoles),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *RolesHTTPClientImpl) UpdateRoles(ctx context.Context, in *UpdateRolesRequest, opts ...http.CallOption) (*UpdateRolesReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationRolesUpdateRoles),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
