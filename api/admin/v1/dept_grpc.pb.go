...
func (c *deptClient) RoleDeptTreeSelect(ctx context.Context, in *RoleDeptTreeSelectRequest, opts ...grpc.CallOption) (*RoleDeptTreeSelectReply, error) {
	...
	err := c.cc.Invoke(ctx, Dept_RoleDeptTreeSelect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDeptServer) ListDept(context.Context, *ListDeptRequest) (*ListDeptReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDept not implemented")
}
func (UnimplementedDeptServer) QueryDeptTree(context.Context, *QueryDeptTreeRequest) (*QueryDeptTreeReply, error) {
	return nil, status.Error(codes.Unimplemented, "method QueryDeptTree not implemented")
}
func (UnimplementedDeptServer) CreateDept(context.Context, *CreateDeptRequest) (*CreateDeptReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateDept not implemented")
}
func (UnimplementedDeptServer) UpdateDept(context.Context, *UpdateDeptRequest) (*UpdateDeptReply, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateDept not implemented")
}
...
func (UnimplementedDeptServer) RoleDeptTreeSelect(context.Context, *RoleDeptTreeSelectRequest) (*RoleDeptTreeSelectReply, error) {
	return nil, status.Error(codes.Unimplemented, "method RoleDeptTreeSelect not implemented")
}
