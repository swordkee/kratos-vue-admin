...
func RegisterDeptHTTPServer(s *http.Server, srv DeptHTTPServer) {
	r := s.Route("/")
	r.Handle("GET", "/system/dept/list", _Dept_ListDept0_HTTP_Handler(srv))
	r.Handle("GET", "/system/dept/deptTree", _Dept_QueryDeptTree0_HTTP_Handler(srv))
	r.Handle("POST", "/system/dept", _Dept_CreateDept0_HTTP_Handler(srv))
	r.Handle("PUT", "/system/dept", _Dept_UpdateDept0_HTTP_Handler(srv))
	r.Handle("DELETE", "/system/dept/{id}", _Dept_DeleteDept0_HTTP_Handler(srv))
	r.Handle("GET", "/system/dept/roleDeptTreeSelect/{roleId}", _Dept_RoleDeptTreeSelect0_HTTP_Handler(srv))
}
...
func (c *DeptHTTPClientImpl) CreateDept(ctx context.Context, in *CreateDeptRequest, opts ...http.CallOption) (*CreateDeptReply, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationDeptCreateDept),
...
func (c *DeptHTTPClientImpl) DeleteDept(ctx context.Context, in *DeleteDeptRequest, opts ...http.CallOption) (*DeleteDeptReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDeptDeleteDept),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *DeptHTTPClientImpl) ListDept(ctx context.Context, in *ListDeptRequest, opts ...http.CallOption) (*ListDeptReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDeptListDept),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *DeptHTTPClientImpl) QueryDeptTree(ctx context.Context, in *QueryDeptTreeRequest, opts ...http.CallOption) (*QueryDeptTreeReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDeptQueryDeptTree),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *DeptHTTPClientImpl) RoleDeptTreeSelect(ctx context.Context, in *RoleDeptTreeSelectRequest, opts ...http.CallOption) (*RoleDeptTreeSelectReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationDeptRoleDeptTreeSelect),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *DeptHTTPClientImpl) UpdateDept(ctx context.Context, in *UpdateDeptRequest, opts ...http.CallOption) (*UpdateDeptReply, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationDeptUpdateDept),
		http.PathTemplate(pattern),
	}, opts...)
