...
func (UnimplementedRolesServer) CreateRoles(context.Context, *CreateRolesRequest) (*CreateRolesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateRoles not implemented")
}
func (UnimplementedRolesServer) UpdateRoles(context.Context, *UpdateRolesRequest) (*UpdateRolesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRoles not implemented")
}
...
func (UnimplementedRolesServer) ChangeRoleStatus(context.Context, *ChangeRoleStatusRequest) (*ChangeRoleStatusReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeRoleStatus not implemented")
}
func (UnimplementedRolesServer) DataScope(context.Context, *DataScopeRequest) (*DataScopeReply, error) {
	return nil, status.Error(codes.Unimplemented, "method DataScope not implemented")
}
func (UnimplementedRolesServer) DeleteRoles(context.Context, *DeleteRolesRequest) (*DeleteRolesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteRoles not implemented")
}
func (UnimplementedRolesServer) FindRoles(context.Context, *FindRolesRequest) (*FindRolesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindRoles not implemented")
}
