...
func (c *dictDataClient) ListDictData(ctx context.Context, in *ListDictDataRequest, opts ...grpc.CallOption) (*ListDictDataReply, error) {
	...
	err := c.cc.Invoke(ctx, DictData_ListDictData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictDataClient) CreateDictData(ctx context.Context, in *CreateDictDataRequest, opts ...grpc.CallOption) (*CreateDictDataReply, error) {
	...
	err := c.cc.Invoke(ctx, DictData_CreateDictData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictDataClient) UpdateDictData(ctx context.Context, in *UpdateDictDataRequest, opts ...grpc.CallOption) (*UpdateDictDataReply, error) {
	...
	err := c.cc.Invoke(ctx, DictData_UpdateDictData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictDataClient) DeleteDictData(ctx context.Context, in *DeleteDictDataRequest, opts ...grpc.CallOption) (*DeleteDictDataReply, error) {
	...
	err := c.cc.Invoke(ctx, DictData_DeleteDictData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDictDataServer must be embedded to have
...
func (UnimplementedDictDataServer) FindDictData(context.Context, *FindDictDataRequest) (*FindDictDataReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDictData not implemented")
}
func (UnimplementedDictDataServer) mustEmbedUnimplementedDictDataServer() {}
func (UnimplementedDictDataServer) testEmbeddedByValue()                  {}
...
func RegisterDictDataServer(s grpc.ServiceRegistrar, srv DictDataServer) {
	// If the following call panics, it indicates UnimplementedDictDataServer was
