    ...
    <el-card shadow="always">
      ...
      <el-form :model="state.queryParams" ref="queryForm" :inline="true">
        <el-form-item label="路径" prop="path">
          <el-input placeholder="Api路径模糊查询" clearable @keyup.enter="handleQuery" style="width: 240px"
            v-model="state.queryParams.path" />
        </el-form-item>
        <el-form-item label="描述" prop="description">
          <el-input placeholder="描述模糊查询" clearable @keyup.enter="handleQuery" style="width: 240px"
            v-model="state.queryParams.description" />
        </el-form-item>
        <el-form-item label="分组" prop="apiGroup">
          <el-input placeholder="分组查询" clearable @keyup.enter="handleQuery" style="width: 240px"
            v-model="state.queryParams.apiGroup" />
        </el-form-item>
        <el-form-item label="方法" prop="method">
          <el-select v-model="state.queryParams.method" placeholder="方法" clearable style="width: 240px">
            <el-option v-for="dict in state.methodOptions" :key="dict.dictValue" :label="dict.dictLabel"
      ...
      <template #header>
        <div class="card-header">
          ...
          <div>
            ...
            <el-button type="danger" plain :disabled="state.multiple" v-auth="'system:api:delete'" @click="onTabelRowDel">
...
onMounted(() => {
  ...
  proxy.getDicts("sys_method_api").then((response: any) => {
    state.methodOptions = response.list;
  });
