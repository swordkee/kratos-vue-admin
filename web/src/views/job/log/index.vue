    ...
    <el-dialog title="调度日志详细" v-model="state.open" width="700px" center append-to-body>
      ...
      >
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="执行时间：">{{ dateStrFormat(state.modelForm.createTime) }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="调用方法：">{{
                state.modelForm.targetInvoke
              }}
            </el-form-item>
          </el-col>
          <el-col :span="12">
